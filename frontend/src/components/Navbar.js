                ...
                <div className="relative w-20 h-20 md:w-24 md:h-24">
                  ...
                  >
                    <div className="relative w-full h-full rounded-full overflow-hidden border-4 border-white/30 shadow-neon">
                      {/* Placeholder - استبدل بالصورة الحقيقية */}
                      <div className="w-full h-full bg-gradient-to-br from-primary-600 via-purple-600 to-neon-600 flex items-center justify-center">
