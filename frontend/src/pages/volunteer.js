...
const VolunteerPage = () => {
  ...
  return (
    <>
      <Head>
        <title>انضم للحملة - تطوع معنا | محمد الناغي</title>
        <meta name="description" content="كن جزءاً من التغيير - انضم لحملة محمد الناغي الانتخابية وساهم في بناء مستقبل أفضل لدائرة منية النصر" />
      </Head>
