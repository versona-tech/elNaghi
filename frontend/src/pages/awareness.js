        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              تعرف على حقوقك وواجباتك كمواطن. نوفر لك كل المعلومات التي تحتاجها
              لتكون مواطناً فاعلاً ومشاركاً في بناء مستقبل أفضل
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              استكشف المواضيع المختلفة لفهم أعمق لحقوقك ودورك في المجتمع
            </p>
          </motion.div>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              كل ما تحتاجه من مصادر موثوقة لزيادة وعيك السياسي والمجتمعي
            </p>
          </motion.div>
