          ...
          <div className="max-w-4xl mx-auto">
            <div className="card p-8 mb-8">
              ...
              <div className="prose prose-lg text-gray-700 leading-relaxed space-y-4">
                <p>
                  أنا محمد إبراهيم علي الناغي، من قرية الرياض – مركز منية النصر بمحافظة الدقهلية. تعلّمت من أسرتي أن
                  خدمة الناس شرف ومسؤولية، وأن احترام الوقت والكلمة أساس النجاح والعمل العام.
                </p>
                <p>
                  بدأت رحلتي في العمل المجتمعي مبكراً عبر مبادرات شبابية لمساندة الأسر الأولى بالرعاية، وتنظيم قوافل
                  صحية ودروس تقوية للطلاب، ثم توسّع النشاط ليشمل المشاركة في مشروعات تحسين الخدمات والبنية الأساسية
                  بالتعاون مع الجهات التنفيذية والمتطوعين من أبناء الدائرة.
                </p>
                <p>
                  رؤيتي بسيطة: أن يحصل كل مواطن على حقه في تعليم جيد، ورعاية صحية لائقة، وفرصة عمل كريمة، وخدمات
                  يومية تحفظ كرامته. أؤمن بالعمل المؤسسي القائم على التخطيط والمتابعة والمحاسبة، وبأن الإنجاز الحقيقي
                  يُقاس بما يلمسه الناس في حياتهم.
                </p>
              </div>
            </div>
